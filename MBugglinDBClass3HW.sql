...
/* #7 */
SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Status' OR TABLE_NAME = 'Locations' OR TABLE_NAME = 'Services'
OR TABLE_NAME = 'GuestStatuses' or TABLE_NAME = 'Classes';
